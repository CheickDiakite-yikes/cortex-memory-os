...
| Shadow Pointer | Validated native proof, static prototype, permission onboarding, capture receipt wiring, visible live clicker demo with request hardening, and read-only permission status smoke | `SHADOW-POINTER-001`, `SHADOW-POINTER-CONTROLS-001`, `SHADOW-POINTER-PERMISSION-ONBOARDING-001`, `POINTER-PROPOSAL-001`, `SHADOW-POINTER-NATIVE-001`, `NATIVE-CAPTURE-PERMISSION-SMOKE-001`, `SHADOW-POINTER-CAPTURE-WIRING-001`, `LIVE-CLICKER-DEMO-001`, `LIVE-CLICKER-HARDENING-001`, static UI prototype, `native/macos-shadow-pointer` | Feed permission onboarding and local endpoint receipt streams into the native overlay panel. |
