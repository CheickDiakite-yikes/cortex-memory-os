...
| Scene, memory, and graph pipeline | Validated skeleton plus synthetic capture-to-memory write/retrieval ladder, visible live clicker demo memory writes, encrypted durable-memory store boundary, and unified encrypted graph/index prototype | `SCENE-SEGMENT-001`, `MEM-COMPILE-001`, `GRAPH-EDGE-001`, `MEMORY-ENCRYPTION-DEFAULT-001`, `UNIFIED-ENCRYPTED-GRAPH-INDEX-001`, `SYNTHETIC-CAPTURE-LADDER-001`, `LIVE-CLICKER-DEMO-001` | Add richer multimodal segmentation and contradiction handling on top of encrypted graph/index storage. |
...
| Memory Palace | Validated dashboard contract, Chronicle-style observation controls, static UI shell, sparse Focus Inspector, Safe Demo Path, read-only gateway action receipts, live gateway runtime explain calls, sanitized read-only action live proof, bounded Computer Use safe-task live run, visible Shadow Clicker memory demo, and sanitized Computer Use browser proof | `MEMORY-PALACE-001`, `PALACE-FLOW-001`, `MEMORY-PALACE-CHRONICLE-CONTROLS-001`, `MEMORY-PALACE-DASHBOARD-001`, `MEMORY-PALACE-SKILL-FORGE-UI-001`, `DASHBOARD-FOCUS-INSPECTOR-001`, `DEMO-READINESS-001`, `DASHBOARD-GATEWAY-ACTIONS-001`, `DASHBOARD-GATEWAY-RUNTIME-READONLY-001`, `DASHBOARD-GATEWAY-RUNTIME-BLOCKLIST-001`, `DASHBOARD-READONLY-ACTION-LIVE-PROOF-001`, `LIVE-RUN-COMPUTER-SAFE-TASK-001`, `LIVE-CLICKER-DEMO-001`, `COMPUTER-DASHBOARD-LIVE-PROOF-001`, self-lesson review flows | Keep correction/delete/export confirmation-gated and wire the safe read-only summaries into the visible dashboard. |
...
| Shadow Pointer | Validated native proof, static prototype, permission onboarding, capture receipt wiring, visible live clicker demo, and read-only permission status smoke | `SHADOW-POINTER-001`, `SHADOW-POINTER-CONTROLS-001`, `SHADOW-POINTER-PERMISSION-ONBOARDING-001`, `POINTER-PROPOSAL-001`, `SHADOW-POINTER-NATIVE-001`, `NATIVE-CAPTURE-PERMISSION-SMOKE-001`, `SHADOW-POINTER-CAPTURE-WIRING-001`, `LIVE-CLICKER-DEMO-001`, static UI prototype, `native/macos-shadow-pointer` | Feed permission onboarding and local endpoint receipt streams into the native overlay panel. |
