...
| Scene, memory, and graph pipeline | Validated skeleton plus synthetic capture-to-memory write/retrieval ladder and encrypted durable-memory store boundary | `SCENE-SEGMENT-001`, `MEM-COMPILE-001`, `GRAPH-EDGE-001`, `MEMORY-ENCRYPTION-DEFAULT-001`, `SYNTHETIC-CAPTURE-LADDER-001` | Add richer multimodal segmentation, contradiction handling, and unified encrypted graph/index storage. |
