...
| --- | --- | --- | --- | --- |
| SELF-LESSON-SCOPE-AUDIT-001 | Add self-lesson audit scope metadata | Codex | Audit listing contract and benchmark case | Audit receipts should expose scope-sensitive state without copying lesson content. |
