...
def test_synthetic_benchmarks_pass():
    ...
    assert len(result.case_results) == 211
    assert {case.suite for case in result.case_results} >= {
        ...
        "PERF-HISTORY-001",
        "GATEWAY-HISTORY-001",
        "OPS-QUALITY-SURFACE-001",
        "MEM-LIFECYCLE-001",
        "MEM-FORGET-001",
        "MANUAL-MEMORY-BOOK-001",
        "MANUAL-MEMORY-CONTEXT-PACK-001",
        "SEC-INJECT-001",
        ...
        "LIVE-CLICKER-HARDENING-001",
        "LIVE-CLICKER-ALLOWLISTED-ORIGIN-001",
